      ...
      <div className="box">
        <div className="box_left">
          <div className="nav">
            ...
            <div className="nav_btn active" onClick={() => callback(3)}>
              Stories
            </div>
          </div>
          <div className="box_content">
            {int ? (
              ...
              <>
                <div className="box_title">Stories</div>
                <div className="box_txt">Our customer and company stories</div>
              </>
            )}
        ...
        <div className="box_right">
          ...
          <div className="type2 type_s active" onClick={() => callback(3)}>
            <div>
              <img src={arrow} className="icon_top" alt="" />
            </div>
            <div className="div">
