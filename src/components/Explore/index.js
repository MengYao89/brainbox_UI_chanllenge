      ...
      <div className="box">
        <div className="box_left">
          <div className="nav">
            ...
            <div className="nav_btn active" onClick={() => callback(2)}>
              Explore
            </div>
          ...
          <div className="box_content">
            {int ? (
              ...
              <>
                ...
                <div className="box_txt">Expiore the best places deals</div>
              </>
            )}
        ...
        <div className="box_right">
          <div className="type_s type1 active" onClick={() => callback(2)}>
            <div>
